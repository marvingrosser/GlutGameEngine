...
void Game::init(){
    ...
    glutDisplayFunc(this->render()); //renderfunktion anbinden
    glutIdleFunc(this->render());// ||
    ...
    glutPassiveMotionFunc(player.mouse()); //mouse funktion einbinden
